...
const Performance = () => {
    return (
        <div>
            <div className="container mx-auto mt-[150px] px-3">
                <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between">
                    ...
                    <div className=" mt-5 lg:mt-0">
                        ...
                        <p className="text-2sm font-normal text-center lg:text-start ff_Ibarra_Real_Nova text-BrilliantLicorice mt-5 max-w-[581px]">
