...
function GotBiggerGols() {
  return (
    <div>
      <div className="  container mx-auto px-5 my-8 lg:py-14 py-10  ">
        <div className=" bigger-shadow px-5 pb-8">
          {" "}
          ...
          <div className="text-center md:pt-6">
            {" "}
            <button className=" rounded-[10px]  sm:w-[337px] w-[240px] mx-auto   py-[21px] text-2md font-bold bg-[#2FA4FF] text-white hover:shadow-lg my-8 duration-300 transition-all ff_dm_sans">
              {" "}
              Get Started
            </button>
          </div>
